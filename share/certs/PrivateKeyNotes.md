...
unlocked to sign the Trollcoin-Qt.app bundle.
...
allowing somebody to distribute a Trollcoin-Qt.app or trollcoin-qt-setup.exe with a valid
...
that the trollcoin-qt.exe file inside the installer had not been tampered with.
