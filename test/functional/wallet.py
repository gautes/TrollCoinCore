...
class WalletTest (TrollcoinTestFramework):
    ...
    def run_test (self):
        ...
        # Send 21 TRC from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 100 TRC in block rewards plus fees, but
        ...
        # Send 10 TRC with subtract fee from amount
        ...
        # Sendmany 10 TRC with subtract fee from amount
