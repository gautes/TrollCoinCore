...
- #7562 `1eef038` Bump transaction version default to 2 (TRCdrak)
...
- #8608 `7e9ab95` Install manpages via make install, also add some autogenerated manpages (nomnomTRC)
...
- #8568 `078900d` new var `DIST_CONTRIB` adds useful things for packagers from contrib (nomnomTRC)
...
- #9206 `e662d28` Make test constant consistent with consensus.h (TRCdrak)
...
### Documentation
- #9243 `806b9e7` Clarify witness branches in transaction.h serialization (dcousens)
