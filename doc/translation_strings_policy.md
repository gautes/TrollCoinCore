...
This document provides guidelines for internationalization of the Trollcoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `trollcoin_en.ts` remains unchanged.
