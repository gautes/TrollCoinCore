...
{
    const char* pszTimestamp = "The Times 24/Mar/2017 Trollcoin was born";
...
public:
    CMainParams() {
        ...
        */
	    ...
	    ( 0, uint256S("fda603fd3a179636f50162e14af75b05838e6ba3e13c6ebc80bc775521827ba7"))
        };

        chainTxData = ChainTxData{
            // Data as of block 00000000000000000166d612d5595e2b1cd88d71d695fc580af64d8da8658c23 (height 446482).
            1490349783, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        */
        ...
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x02)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();
...
public:
    CRegTestParams() {
        ...
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,139);
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x03)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x01)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();
    }
