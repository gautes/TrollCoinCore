...
QString TrollcoinUnits::description(int unit)
{
    switch(unit)
    {
    case TRC: return QString("Trollcoins");
    case mTRC: return QString("Milli-Trollcoins (1 / 1" THIN_SP_UTF8 "000)");
    case uTRC: return QString("Micro-Trollcoins (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
    default: return QString("???");
    }
}
