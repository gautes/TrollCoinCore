...
const char * const TROLLCOIN_CONF_FILENAME = "trollcoin.conf";
const char * const TROLLCOIN_PID_FILENAME = "trollcoind.pid";
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", TROLLCOIN_PID_FILENAME));
